...
Mean total steps = `r round(mean_total_steps)` <br/>

Median total steps = `r median_total_steps`
...
The interval with the most steps is `r interval_with_max`.
...
Mean total steps = `r imputed_mean_total_steps` <br/>

Median total steps = `r imputed_median_total_steps`
